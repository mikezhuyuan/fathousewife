...
CBHelper.prototype.removeDocument = function(conditions, collection, files, responder) {
	url = this.generateUrl() + "/" + this.appCode + "/" + collection + "/remove";
	this.sendHttpRequest("data", url, {"cb_search_key" : conditions}, null, files, responder);
};
